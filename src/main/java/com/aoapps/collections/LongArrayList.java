...
public class LongArrayList extends AbstractList<Long>
  ...
  public boolean contains(Object elem) {
    ...
    if (elem instanceof Number) {
      return contains(((Number) elem).longValue());
    }
    return false;
  }
   ...
   * for equality using the {@link LongArrayList#equals(java.lang.Object) equals} method.
   *
  ...
  public int indexOf(Object elem) {
    ...
    if (elem instanceof Number) {
      return indexOf(((Number) elem).longValue());
    }
    return -1;
  }
  ...
  public int lastIndexOf(Object elem) {
    ...
    if (elem instanceof Number) {
      return lastIndexOf(((Number) elem).longValue());
    }
    return -1;
  }
  ...
  public boolean remove(Object o) {
    if (o instanceof Number) {
      return removeByValue(((Number) o).longValue());
    }
    return false;
  }
  ...
  /*
   * Private removeByValue method that skips bounds checking and does not
